...
\begin{figure}
\begin{center}
\begin{tikzpicture}[shorten >=1pt,->,draw=black!50, node distance=\layersep, scale=.9]
    ...
    \node[output neuron, right of=A-turn-3] (V) at (\layersepst + \layersep+\layersep,-2.3)  {$\vec{v_d}$};
