...
\begin{tikzpicture}[shorten >=1pt,->,draw=black!50, node distance=\layersep]
    ...
    \node[output neuron, right of=A-turn-3] (V) at (\layersept + \layersep+\layersep+\layersep,-2.2)  {$v_d$};
    ...
    \node[semantic neuron] (sem) at (\layersept + \layersep+\layersep+\layersep,-0.2) {$u_{sem}$};
